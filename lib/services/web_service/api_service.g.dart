...
class _RestClient implements RestClient {
  ...
  Future<List<PeopleModel>> getPeoples() async {
    ...
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<PeopleModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<BeerSummary>> getBeer(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<BeerSummary>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
